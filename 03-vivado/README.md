...
begin
  ...
  f_o <= a_i when (outp_i = "00") else
           b_i when (outp_i = "01") else
           c_i when (outp_i = "10") else
...
set_property -dict { PACKAGE_PIN H6   IOSTANDARD LVCMOS33 } [get_ports { outp_i[0] }]; #IO_L24P_T3_35 Sch=sw[12]
set_property -dict { PACKAGE_PIN U12  IOSTANDARD LVCMOS33 } [get_ports { outp_i[1] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
