...
#
# Generated by Vivado on Tue Apr 11 14:06:06 +0200 2023
...
xv_boost_lib_path=C:/appz/Xilinx/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L sim_clk_gen_v1_0_2 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/appz/Xilinx/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
