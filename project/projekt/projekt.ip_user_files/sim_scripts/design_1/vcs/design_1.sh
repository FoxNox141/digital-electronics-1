...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    ...
    "$ref_dir/../../../bd/design_1/ip/design_1_UART_TX_0_1/sim/design_1_UART_TX_0_1.vhd" \
    "$ref_dir/../../../bd/design_1/ip/design_1_UART_RX_0_1/sim/design_1_UART_RX_0_1.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work sim_clk_gen_v1_0_2 $vlogan_opts +v2k \
    "$ref_dir/../../../../projekt.gen/sources_1/bd/design_1/ipshared/b740/hdl/sim_clk_gen_v1_0_vl_rfs.v" \
